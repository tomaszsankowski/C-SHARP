...
internal static class LinqToXmlCarQueries
{
    public static void Main()
    {
        ...
        Console.WriteLine($"Œrednia moc samochodów bez silników TDI: {avgHP}");

        //
        IEnumerable<XElement> models = rootNode.XPathSelectElements("car/Model[not(. = following::Model)]");

        Console.WriteLine("\nModele samochodów bez powtórzeñ:");
