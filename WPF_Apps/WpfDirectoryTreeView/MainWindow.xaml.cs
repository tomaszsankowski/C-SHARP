            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                if (isFile && Regex.IsMatch(itemName, pattern))
                {
                    try
                    {
                        ...
                        {
                            System.Windows.MessageBox.Show("Plik o tej nazwie ju¿ istnieje!");
                        }
                    }
                    catch (Exception ex)
                    {
                        System.Windows.MessageBox.Show($"B³¹d podczas tworzenia pliku: {ex.Message}");
                    }
                }
                else if (isFolder)
                {
                    try
                    {
                        ...
                        {
                            System.Windows.MessageBox.Show("Folder o tej nazwie ju¿ istnieje!");
                        }
                    }
                    catch (Exception ex)
                    {
                        System.Windows.MessageBox.Show($"B³¹d podczas tworzenia folderu: {ex.Message}");
                    }
                }
                else
                {
                    System.Windows.MessageBox.Show("Nie mo¿na utworzyæ pliku o takim rozszerzeniu lub niepoprawnej nazwie!");
                }
            }
        }
